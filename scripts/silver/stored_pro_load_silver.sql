...
-- Normalize status values to readable format
...
-- Adding new, relevant data to enhance the dataset for analysis
...
-- Derive price if original value is invlaid
...
-- Normalize gender values and handle  unknown cases
      CASE WHEN UPPER(TRIM(gen)) IN ('F','FEMALE') THEN 'Female'
	   WHEN UPPER(TRIM(gen)) IN ('M','MALE') THEN 'Males'
	   ELSE 'N/A'
      END AS gen
