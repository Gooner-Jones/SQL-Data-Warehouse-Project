...
GO
CREATE TABLE bronze.crm_sales_details (sls_ord_num  NVARCHAR(50),
...
GO
CREATE TABLE bronze.erp_loc_a101(cid    NVARCHAR(50),
				 cntry  NVARCHAR(50));
GO

-- Create bronze.erp_cust_az12 tabel
IF OBJECT_ID('bronze.erp_cust_az12', 'U') IS NOT NULL
    DROP TABLE bronze.erp_cust_az12;
GO
CREATE TABLE bronze.erp_cust_az12 (cid    NVARCHAR(50),
					  bdate  DATE,
					  gen    NVARCHAR(50));
GO
